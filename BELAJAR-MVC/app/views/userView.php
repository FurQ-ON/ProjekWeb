                ...
                <?php foreach ($users as $user) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?action=delete&id=<?php echo $user['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Yakin Menghapus?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
